...
public class BuscaEletricista extends AppCompatActivity {
    ...
    public void BuscaUsuarios(){
        db.collection("users")
                .whereEqualTo("trabalho", "Eletricista")
                .get()
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult() ) {
                                ...
                                if (user.getUid() != usuarioAtual) {
                                    ...
                                    adapter = new AdapterBusca(BuscaEletricista.this, itens);
                                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(BuscaEletricista.this,
